...
- **[Modern CSS Daily](https://modern-css.davecross.co.uk/)**  
  A daily look at “modern” CSS features (roughly the last twenty years) with short, focused examples. Ideal if you last seriously looked at CSS some time ago and would like to catch up without wading through a textbook.

## Everything else

- **[Links](https://links.davecross.co.uk/)**  
  A simple link hub with more places to find me and my work around the web.

---

If you’d like to work together, the easiest way to reach me is still the [contact form on this site](/contact/). You’ll also find an RSS/Atom feed and other useful bits down in the footer.
